...
def nts_scores(distance_matrix_1: np.ndarray, distance_matrix_2: np.ndarray) -> dict[str, float]:
...
def nts_metrics(distance_matrix_1: np.ndarray, distance_matrix_2: np.ndarray) -> dict[str, float]:
    return nts_scores(distance_matrix_1, distance_matrix_2)
...
def rtd_srtd_lite_scores(distance_matrix_1: np.ndarray, distance_matrix_2: np.ndarray, *, q: float = 0.90) -> dict[str, float]:
    matrix_1, matrix_2 = validate_pair(distance_matrix_1, distance_matrix_2)
...
def rtd_srtd_lite_metrics(distance_matrix_1: np.ndarray, distance_matrix_2: np.ndarray, *, q: float = 0.90) -> dict[str, float]:
    return rtd_srtd_lite_scores(distance_matrix_1, distance_matrix_2, q=q)
